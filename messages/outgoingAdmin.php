...
$query="SELECT * FROM messages WHERE fromUser='".$_SESSION['SESS_ADMIN_USERNAME']."' AND deletedAdmin='0' ";
...
(new MessagePage)->show("", "Съобщението e изтрито!", "danger","outgoingAdmin","800");
mysql_close();
}
