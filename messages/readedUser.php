...
$query="SELECT * FROM messages WHERE toUser='".$_SESSION['SESS_USERNAME']."' AND readed='1' AND deleted='0'";
...
(new MessagePage)->show("", "Съобщението e изтрито!", "danger","readedUser","800");
mysql_close();
}
...
<div class="panel panel-warning">
					...
					<div class="panel-body">
						<div class="btn-group">
						<a href="incomingUser" class="btn btn-info" >Непрочетени</a>
